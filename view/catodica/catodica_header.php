...
<head>
	...
	<script type="text/javascript" src="../../js/catodica.js"></script>
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" style="background-image:url('../../images/banner-proteccion-catod.png');" >

			<div class="container clearfix">
				<h1 style="color:white">PROTECCIÓN CATÓDICA</h1>
		...
		<div id="page-menu" class="no-sticky" >
			...
			<div id="page-menu-wrap" style="background-color:#fbb034; color:white">

				<div class="container clearfix">
					<nav style=" float:left">
						<ul>
							<li id="li_1" class="current"><a href="<?php echo CTRL?>catodica/index.php?accion=magnesio">Ánodos de Magnesio</a></li>
							<li id="li_2"><a href="<?php echo CTRL?>catodica/index.php?accion=zinc">Ánodos de Zinc</a></li>
							<li id="li_3"><a href="<?php echo CTRL?>catodica/index.php?accion=aluminio">Ánodos de Aluminio</a></li>
							<li id="li_4"><a id="corriente_impresa">Corriente Impresa</a></li>
							<li id="li_5"><a id="soldaduras">Soldaduras Exotérmicas - Cadweld</a></li>
							<li id="li_6"><a id="monitoreo">Monitoreo Remoto</a></li>
