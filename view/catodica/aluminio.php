									...
									<div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
										<div class="flexslider">
											<div class="slider-wrap">
												<a href="catodica_producto.php?id=<?php echo $producto['id']; ?>"><img src="../../images/catodica/AA/minis/<?php echo $producto["url_img"]; ?>" alt=""></a>
											</div>
										</div>
									</div>

										<div class="portfolio-overlay" data-lightbox="gallery">
										<a href="catodica_producto.php?id=<?php echo $producto['id']; ?>" class="center-icon" ><i class="icon-line-plus"></i></a>
